    ...
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        <div class="sidebar-brand d-none d-md-flex">
            <a href="http://127.0.0.1:8000/admin/dashboard">
                <img class="sidebar-brand-full" src="http://127.0.0.1:8000/img/backend-logo.jpg" height="46"
                    alt="Laravel Starter">
                <img class="sidebar-brand-narrow" src="http://127.0.0.1:8000/img/backend-logo-square.jpg" height="46"
                    alt="Laravel Starter">
            </a>
        </div>
                        ...
                        <div class="simplebar-content-wrapper" tabindex="0" role="region"
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#"><i
                                            class="nav-icon fas fa-file-alt"></i> Article</a>
                                    <ul class="nav-group-items">
                                        <li class="nav-item"><a class="nav-link"
                                                href="http://127.0.0.1:8000/admin/posts"><i
                                                    class="nav-icon fas fa-file-alt"></i> Posts</a></li>
                                        <li class="nav-item"><a class="nav-link"
                                                href="http://127.0.0.1:8000/admin/categories"><i
                                                    class="nav-icon fas fa-sitemap"></i> Categories</a></li>
                                    </ul>
                                </li>
