                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#"><i class="nav-icon fas fa-file-alt"></i>TRUSK MASK</a>
                                    <ul class="nav-group-items">
                                        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#"><i class="nav-icon fas fa-file-alt"></i>VClaim</a>
                                            <ul class="nav-group-items">
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>Lembar Pengajuan Klaim</a>
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>Monitoring</a>
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>Peserta</a>
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>PRB</a>
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>Referensi</a>
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>PR Kontrol/SPRI</a>
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>Cari Rujukan</a>
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>SEP</a>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <!-- VCLAIM -->
                                <li class="nav-group"><a class="nav-link nav-group-toggle" href="#"><i class="nav-icon fas fa-file-alt"></i>PCARE</a>
                                    <ul class="nav-group-items">
                                        <li class="nav-group"><a class="nav-link nav-group-toggle" href="#"><i class="nav-icon fas fa-file-alt"></i>VClaim</a>
                                            <ul class="nav-group-items">
                                                ...
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>Kunjungan</a>
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>PR Kontrol/SPRI</a>
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>Cari Rujukan</a>
                                                <li class="nav-group"><a class="nav-link" href="#"><i class="nav-icon fas fa-file-alt"></i>SEP</a>
                                            </ul>
